...
type NotificationBatchResp struct {
	Data interface{} `json:"data,optional"`
}
...
type PointsOrderResp struct {
	Data interface{} `json:"data,optional"`
}

type PointsProductResp struct {
	Data interface{} `json:"data,optional"`
}
...
type TaskEventReq struct {
	...
	RefId    string `json:"ref_id,optional"`  // 实际以 types.FlexUint64 解析；api 声明放宽
	UserId   uint64 `json:"user_id,optional"` // internal 调用时必填
}

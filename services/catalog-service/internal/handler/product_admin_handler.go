...
func (h *ProductAdminHandler) AuthMe(w http.ResponseWriter, r *http.Request) {
	shopID, uid, ok := h.shopUser(r)
	if !ok {
		response.Error(w, "缺少店铺上下文", http.StatusForbidden)
		return
...
func (h *ProductAdminHandler) ListRoles(w http.ResponseWriter, r *http.Request) {
	shopID, _, ok := h.shopUser(r)
	if !ok {
		response.Error(w, "缺少店铺上下文", http.StatusForbidden)
		return
...
func (h *ProductAdminHandler) ListMenus(w http.ResponseWriter, r *http.Request) {
	shopID, uid, ok := h.shopUser(r)
	if !ok {
		response.Error(w, "缺少店铺上下文", http.StatusForbidden)
		return
...
func (h *ProductAdminHandler) RoleMenus(w http.ResponseWriter, r *http.Request) {
	_, _, ok := h.shopUser(r)
	if !ok {
		response.Error(w, "缺少店铺上下文", http.StatusForbidden)
		return
...
func (h *ProductAdminHandler) SaveRole(w http.ResponseWriter, r *http.Request) {
	shopID, uid, ok := h.shopUser(r)
...
func (h *ProductAdminHandler) ListStaff(w http.ResponseWriter, r *http.Request) {
	shopID, _, ok := h.shopUser(r)
	if !ok {
		response.Error(w, "缺少店铺上下文", http.StatusForbidden)
		return
...
func (h *ProductAdminHandler) BindStaff(w http.ResponseWriter, r *http.Request) {
	shopID, uid, ok := h.shopUser(r)
	if !ok || !h.svcCtx.ShopRBAC.IsOwner(shopID, uid) {
		response.Error(w, "仅店主可操作", http.StatusForbidden)
		return

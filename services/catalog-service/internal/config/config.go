...
type TelemetryConf struct {
	Enabled  bool
	Endpoint string
	Service  string `json:",default=catalog-service"`
}
...
func (c *Config) OverlayFromEnv() {
	...
	overlayMySQL(&c.MySQL)
	overlayRedis(&c.Redis)
...
func overlayRabbit(r *RabbitMQConf) {

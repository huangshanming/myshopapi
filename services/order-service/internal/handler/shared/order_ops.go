...
func Ship(w http.ResponseWriter, r *http.Request, l *logic.OrderLogic, shopID uint64) {
...
func Complete(w http.ResponseWriter, r *http.Request, l *logic.OrderLogic, shopID uint64) {
	orderID, err := strconv.ParseUint(httpserver.PathParam(r, "id"), 10, 64)
	if err != nil {
		httpx.ErrorCtx(r.Context(), w, xerr.New(http.StatusBadRequest, "订单ID无效"))
		return
...
func Remark(w http.ResponseWriter, r *http.Request, l *logic.OrderLogic, shopID uint64) {
	orderID, err := strconv.ParseUint(httpserver.PathParam(r, "id"), 10, 64)
	if err != nil {
		httpx.ErrorCtx(r.Context(), w, xerr.New(http.StatusBadRequest, "订单ID无效"))
		return
...
func HandleAfterSale(w http.ResponseWriter, r *http.Request, l *logic.OrderLogic, shopID, handledBy uint64) {

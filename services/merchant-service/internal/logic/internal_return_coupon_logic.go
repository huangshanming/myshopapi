...
func (l *InternalReturnCouponLogic) InternalReturnCoupon(w http.ResponseWriter, r *http.Request) {
	hinternal.NewCouponHandler(l.svcCtx).InternalReturnCoupon(w, r)
}

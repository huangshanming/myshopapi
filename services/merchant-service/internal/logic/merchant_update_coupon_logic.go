...
func (l *MerchantUpdateCouponLogic) MerchantUpdateCoupon(w http.ResponseWriter, r *http.Request) {
	hmerchant.NewCouponHandler(l.svcCtx).MerchantUpdateCoupon(w, r)
}

...
func (l *PointsOrderLogic) AdminCancel(id uint64, remark string) (*PointsOrderVO, error) {
	...
	if l.svcCtx.UserHTTP == nil {
		return nil, errors.New("积分服务未配置")
	}
	if err := l.svcCtx.UserHTTP.RefundPoints(l.ctx, userhttp.PointsLedgerReq{
...
func (l *PointsOrderLogic) UserExchange(userID uint64, req ExchangeReq) (*model.PointsExchangeOrder, error) {
	...
	if err := l.svcCtx.UserHTTP.DeductPoints(l.ctx, userhttp.PointsLedgerReq{

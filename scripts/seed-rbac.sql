...
(146, 16, '九宫格抽奖', 'menu', '/admin/lottery', 'admin/Lottery', 'Present', 'marketing:lottery:list', 36, 1, 1),
(148, 16, '抽奖记录', 'menu', '/admin/lottery-records', 'admin/LotteryRecords', 'Tickets', 'marketing:lottery:list', 37, 1, 1),
(147, 16, '抽奖实物订单', 'menu', '/admin/lottery-orders', 'admin/LotteryOrders', 'Van', 'marketing:lottery:order', 38, 1, 1),

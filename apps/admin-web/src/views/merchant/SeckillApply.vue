<template>
  <div>
    ...
    <el-alert
      ...
      show-icon
      class="mb"
      :title="`报名费 ¥${rule.apply_fee} / 每店每场最多 ${rule.max_entries_per_shop} 个商品 / 场次时长 ${rule.duration_hours} 小时`"
    />
...
import {
  applySeckill, fetchMerchantSeckillEntries, fetchMerchantSeckillSessions,

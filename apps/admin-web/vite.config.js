...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      ...
      '/uploads/points-mall': to(svc.merchant),
      ...
      '/api/v1/admin/points-products': to(svc.merchant),
      '/api/v1/admin/points-orders': to(svc.merchant),
      '/api/v1/user/points-mall': to(svc.merchant),
